    ...
    return (
                <div className={classes.Profile_container} id="profile">
                    ...
                    <div className={classes.Profile_description}>
                        ...
                        {!props.mobile? <p>Amdy’s remarkable story of escaping a Civil War in Burundi as a little boy, surviving the dangerous forest where only he and 1 boy survived from a group of over 20 boys, fleeing to South Africa with the help of Doctors Without Borders, beyond the trauma and tragedy, building his new life in South Africa with the help of an adopting mother, successfully matriculating within 1 year with no formal education.
                            ...
                            <p>Amdy started his own company named MD Home Repairs.  In the field, he also attained experience in the area of electrical work.  He is very hands-on and loves taking on responsibility.  Amdy is now in the process of setting up the company to be able to take on larger projects in the industry.</p>}
